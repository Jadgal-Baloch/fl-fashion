...
import { Plus, Filter, Search, ArrowUpDown, Users } from "lucide-react"

// Sample supplier data based on the original design
const supplierData = [
  {
    supplierNo: "306",
    name: "DESTINA",
...
export default function SetupPage() {
  ...
  const sortedData = useMemo(() => {
    if (!sortColumn) return supplierData
  ...
  }, [supplierData, sortColumn, sortDirection])

  const filteredData = useMemo(
    () =>
      sortedData.filter(
        (item) => item.name.toLowerCase().includes(searchTerm.toLowerCase()) || item.supplierNo.includes(searchTerm),
      ),
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      ...
      <main className="p-6 max-w-7xl mx-auto">
        ...
        {/* Page Title */}
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-8 tracking-tight">Supplier</h1>
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            >
              <CardHeader className="pb-2">
                <CardTitle className="text-base font-semibold text-gray-900 dark:text-white">Buyer</CardTitle>
              </CardHeader>
            ...
            >
              <CardHeader className="pb-2">
                <CardTitle className="text-base font-semibold text-gray-900 dark:text-white">Supplier</CardTitle>
              </CardHeader>
              <CardContent className="space-y-3">
                <Button
                  variant="ghost"
            ...
            >
              <CardHeader>
                <div className="flex items-center justify-between">
                  <CardTitle className="text-2xl font-semibold text-gray-900 dark:text-white">Supplier</CardTitle>
                  <Badge
                    variant="secondary"
                      ...
                      <tbody>
                        {paginatedData.map((item, index) => (
                          ...
                          >
                            ...
                            <td className="p-4 text-sm text-gray-900 dark:text-white">{item.phone}</td>
                            <td className="p-4 text-sm text-gray-900 dark:text-white">{item.email}</td>
                            <td className="p-4 text-sm text-gray-900 dark:text-white">{item.address}</td>
                          </tr>
                        ))}
                      </tbody>
                    </table>
